...
import { Table, TableBody, TableCell, TableCellHead, TableHead, TableRow, TableRowHead, InputField, Button } from "@dhis2/ui";
...
const SearchComp = () => {
  ...
  const successAlert = useAlert("Data successfully posted.", { success: true, duration: 3000 });
  const errorAlert = useAlert("Failed to update the facility.", { critical: true, duration: 3000 });
    ...
    <div className="search-container">
      ...
      <div className="table-button-container">
        <div className="searchBtn">
          <Button basic medium onClick={handleSearch} style={{ width: "150px" }}>
            Search
          </Button>
        </div>
        <Table>
        ...
        <div className="updateBtn">
          <Button onClick={handleUpdate} primary large disabled={loading} style={{ width: "100%", maxWidth: "200px", marginTop: "20px" }}>
